...
/* ==========================================================================
 * TRABAJOS REALIZADOS (bordados) — pestaña "Productos"
 *
 * Biblioteca de fotos de prendas ya personalizadas. Se sube la foto UNA vez y
 * se engancha a los productos donde aplica; la ficha mayorista de la tienda las
 * muestra debajo del botón de WhatsApp ("Así queda tu logo en esta prenda").
 *
 * Un trabajo SIN productos vinculados es "general" y aparece de relleno en
 * cualquier ficha, así ninguna queda con una sola foto suelta.
 * Backend: src/works.js — Theme: snipplets/product/product-works.tpl
 * ========================================================================== */
