  ...
  for (let i = 0; i < daysAhead; i += 1) {
    ...
    const result = await pool.query(
      `INSERT INTO content_calendar
         (scheduled_date, platform, post_type, format, pillar, pillar_detail, automation_level, interaction_hint, scheduled_time, theme_title, status)
       VALUES ($1, 'instagram', $2, $3, $4, $5, $6, $7, $8, $9, $10)
